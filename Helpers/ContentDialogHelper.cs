        ...
        public static ContentDialog CreateHttpDialog(BikaHttpStatus status,string messages)
        {
            ...
            switch (status)
            {
                case BikaHttpStatus.TimeOut:
                    img.Source = new BitmapImage(new Uri("ms-appx:///ShadowViewer.Plugin.Bika/Assets/Picacgs/icon_unknown_error.png"));
                ...
                case BikaHttpStatus.NoAuth:
                    img.Source = new BitmapImage(new Uri("ms-appx:///ShadowViewer.Plugin.Bika/Assets/Picacgs/icon_exclamation_error.png"));
